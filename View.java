...
public class View {
    ...
    private static final Insets insets = new Insets(2,2,0,0);
    ...
    Equals_Button.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent evt) {
           ...
           numbox.setText(Double.toString(Control.Add(Control.inputArr)[0]));
           errbox.setText(Double.toString(Control.Add(Control.inputArr)[1]));
        }
    });
