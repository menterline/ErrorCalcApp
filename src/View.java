...
public class View {
    ...
    private static JButton ErrButton;
    ...
    public static void main(String[] args) 
    {
        ...
        errbox_label.setFont(new Font("Dialog", 1, 20));
		...
		addOperationButton(clearButton, "CLEAR", 2, 0, 1, 1);
		
        //Backspace
        backspaceButton = new JButton("Back");
        addOperationButton(backspaceButton, "BACK", 2, 1, 1, 1);

		//PLusMinus sign
        JButton NegButton = new JButton("\u00B1");
		addOperationButton(NegButton, "NEGATIVE", 6, 2, 1, 1);
		
        //Button to change to error entry	
        ErrButton = new JButton("Error");
        addOperationButton(ErrButton, "ERROR", 2, 2, 1, 1);
    ...
    private static void addButton(JButton currentButton)
    {
        ...
        currentButton.setMargin(new Insets(1,1,1,1));
    ...
    private static void addOperationButton(JButton currentButton, String op, int gridx, int gridy, int gridwidth, int gridheight) 
    {
        ...
        case "DIVIDE":
            ...
            break;
		case "BACKSPACE":
			addBackspaceButton(currentButton);
			break;
		case "CLEAR":
			addClearButton(currentButton);
			break;
		case "NEGATIVE":
			addNegativeButton(currentButton);
			break;
        }
    }

    private static void addErrorButton(JButton currentButton)
    {
        currentButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent evt) {
    ...
    private static void addClearButton(JButton currentButton)
    {
        currentButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent evt) {
    ...
    private static void addBackspaceButton(JButton currentButton)
    {
        currentButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent evt) {
                    boolean errStatus = Control.errStatus;
	...
	private static void addNegativeButton(JButton currentButton)
	{
		currentButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				boolean errStatus = Control.errStatus;
